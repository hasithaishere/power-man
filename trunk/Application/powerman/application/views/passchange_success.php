		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
              ...
              <center>  <div id="company-logo"><img src="<?php echo base_url();?>img/login-bg.png" /></div> </center>
					...
					<h1>Password Recovery Completed</h1>
					<h2 style="width: 89%;color: #646464;font-size: 14px;font-style:italic;">Your Password successfully changed. Please use new password in newxt login.</h2>
                    <hr>
					<form class="form-horizontal" action="<?php echo base_url();?>" method="post">
						<fieldset>
							
							<div class="button-login" style="margin-top: 0% ! important;">	
								<button type="submit" class="btn btn-success" id="btn_changepassword"><i class="icon-off icon-white"></i> Go to Login</button>
							</div>
