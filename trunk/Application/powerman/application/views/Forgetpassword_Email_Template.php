...
<table id="emailContent" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
    	<td colspan="3" style="background:#f00a81;" bgcolor="#f00a81" width="600">
        	<table border="0" cellpadding="0" cellspacing="0">
            	<tbody><tr>
                    <td colspan="3" style="background:#f00a81;line-height:0; font-size:0;" align="center" width="600"><a href="http://www.domore.lk"><img class="header" src="<?php echo base_url();?>img/fp_img/header-welcome-plain.png" alt="Welcome to Domore" title="Welcome to Domore" style="display:block;" border="0" height="69" width="600"></a></td>
                </tr>
            </tbody></table>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td width="528">
        	<table border="0" cellpadding="0" cellspacing="0">
                <tbody>
                <tr>
                    <td style="color:#3f3f3f; font-family:Helvetica, Arial, sans-serif; font-size:20px; line-height:50px;padding:0; margin:0; margin-bottom:0;" align="left" width="528"><strong>Domore Technologies PowerMan Solutions</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                	<td width="528">
                    	<table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                            	<td class="promoContent" style="color:#111111; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:18px;" align="left" width="160px"><a href="#" target="_blank"><img src="<?php echo base_url();?>img/fp_img/click-button.png" alt="Go to My Account" title="Go to My Account" class="account-cta" border="0"></a></td>
                                <td class="promoContent" style="color:#111111; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:18px; font-weight:bold;" align="left" width="300px">To reset the process</td>
                            </tr>
                        </tbody></table>
                    </td>
                ...
                <tr>
                	...
                	<td width="528">
                    	<table border="0" cellpadding="0" cellspacing="0">
                        	<tbody><tr>
                            	<td rowspan="2" class="promoImage" align="left" width="54"><a href="#"><img src="<?php echo base_url();?>img/fp_img/welcome-icon-resume.png" alt="Apply anywhere" title="Apply anywhere" class="promoImage" border="0" height="42" width="40"></a></td>
