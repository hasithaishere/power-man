...
class add_newPackage extends CI_Controller
{
	...
	$this->load->library('form_validation');
		...
		$this->form_validation->set_rules('mDevices','Main Devices','trim|required');
		$this->form_validation->set_rules('sDevices','Sub devices','trim|required');
		$this->form_validation->set_rules('smsAmount','SMS Amount','trim|required');
