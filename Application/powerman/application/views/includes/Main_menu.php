...
<div class="span2 main-menu-span"><!--/span-->
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						//{?>
                              <?php if(in_array(15,$this->session->userdata('user_roles')))echo" <li><a class=\"submenu\" href=\"".base_url()."add_newPackage\"><i class=\"fa-icon-file-alt\"></i><span class=\"hidden-tablet\"> Add New Package</span></a></li>";?>
                        <?php // } ?>
                                
								<?php if(in_array(6,$this->session->userdata('user_roles')))echo" <li><a class=\"submenu\" href=\"". base_url()."power_device\"><i class=\"fa-icon-file-alt\"></i><span class=\"hidden-tablet\"> Add Power Device</span></a></li>";?>
                                
                               <?php if(in_array(8,$this->session->userdata('user_roles')))echo" <li><a class=\"submenu\" href=\"". base_url()."define_device\"><i class=\"fa-icon-file-alt\"></i><span class=\"hidden-tablet\"> Define the Devices</span></a></li>";?>
						...
						<li>
							...
							<ul>
								...
								<?php if(in_array(1,$this->session->userdata('user_roles')))echo "<li><a class=\"submenu\" href=\"". base_url() . "create_user\"><i class=\"fa-icon-file-alt\"></i><span class=\"hidden-tablet\"> Create User</span></a></li>";?>
								<?php if(in_array(2,$this->session->userdata('user_roles')))echo "<li><a class=\"submenu\" href=\"". base_url(). "users_details\"><i class=\"fa-icon-file-alt\"></i><span class=\"hidden-tablet\"> All Users</span></a></li>";?>
