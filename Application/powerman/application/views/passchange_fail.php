		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
              ...
              <center>  <div id="company-logo"><img src="<?php echo base_url();?>img/login-bg.png" /></div> </center>
					...
					<h2 style="width: 89%;color: #646464;font-size: 14px;font-style:italic;">Can't complete password recovery process, please try again or contact Domore Help Support.</h2>
                    <hr>
					<form class="form-horizontal" action="<?php echo base_url();?>" method="post">
						<fieldset>
							
							<div class="button-login" style="margin-top: 0% ! important;">	
								<button type="submit" class="btn btn-info" id="btn_changepassword"><i class="icon-off icon-white"></i> Go to Login</button>
							</div>
