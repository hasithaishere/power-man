...
CREATE TABLE `power_users` (
  ...
  `address_lin_1` varchar(100) default NULL,
  `address_lin_2` varchar(100) default NULL,
  ...
  `registerstatus` tinyint(4) default NULL,
  `created_by` int(11) default NULL,
  `created_on` datetime default NULL,
  `modified_by` int(11) default NULL,
  `modified_on` datetime default NULL,
...
INSERT INTO `power_users` (`id`,`fname`,`lname`,`address_lin_1`,`address_lin_2`,`city`,`province`,`zip_code`,`country`,`email`,`password`,`package_category`,`role`,`lock`,`lock_time`,`status`,`adminstatus`,`registerstatus`,`created_by`,`created_on`,`modified_by`,`modified_on`) VALUES 
 (1,'Hasitha','Gamage',NULL,NULL,'Ratnapura',NULL,NULL,NULL,'admin@gmail.com','202cb962ac59075b964b07152d234b70',NULL,1,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL),
 (2,'Hasitha','Gamage',NULL,NULL,'Ratnapura',NULL,NULL,NULL,'hasitha@gmail.com','202cb962ac59075b964b07152d234b70',NULL,2,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL);
